...
classes: wide
header:
  teaser: /assets/images/buddyboss/logo2.png
ribbon: black
...
|----------|-------------------|
| **APK secret extraction** | The threat actor's workstation contains a `Scan_APK/GITHUB/` directory with cloned BuddyBoss repositories. BuddyBoss has a mobile application that may embed API tokens | 
| **Stolen credentials** | No supporting evidence, no evidence of public breach associated with the victim | 
